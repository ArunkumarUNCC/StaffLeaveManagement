<?php
	...
	$get=mysql_query("SELECT a.*,b.`staff_name`,b.`department` FROM $tb_name a,`leave_users` b WHERE a.`staff_id`=b.`staff_id` AND a.`hod`='Approve' AND a.`admin`='Approve' AND `principal`!='Approve'");
